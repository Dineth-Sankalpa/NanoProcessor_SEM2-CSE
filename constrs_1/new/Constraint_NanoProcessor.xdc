...
set_property PACKAGE_PIN P3 [get_ports {NEG_FLAG_LED}]
	set_property IOSTANDARD LVCMOS33 [get_ports {NEG_FLAG_LED}]
set_property PACKAGE_PIN N3 [get_ports {Jump_Flag_LED}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Jump_Flag_LED}]
set_property PACKAGE_PIN P1 [get_ports {Zero_Flag_LED}]
    set_property IOSTANDARD LVCMOS33 [get_ports {Zero_Flag_LED}]
set_property PACKAGE_PIN L1 [get_ports {Overflow_Flag_LED}]
    set_property IOSTANDARD LVCMOS33 [get_ports {Overflow_Flag_LED}]
